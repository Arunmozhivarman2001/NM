The GitHub repository  https://arunmozhivarman2001.github.io/NM/hosts a Python-based application designed to facilitate voice-based note-taking and memo management.
